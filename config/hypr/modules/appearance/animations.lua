...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 8, bezier = "easeOutBack", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 8, bezier = "easeOutExpo", style = "slide" })
